...
const receita1 = creadorDeReceita(
  "Risoto de Frango",
  "Risoto de frango simples com queijo",
  "queijo",
  "presunto",
  "molho de tomate"
);
...
const receita2 = creadorDeReceita(
  "Brigadeiro Gourmet",
  "Brigadeiro cremoso com creme de leite",
  "Creme de leite",
  "Leite condensado"
);
...
console.log(" ");
console.log(
  "----------- usando Constructor, inicia com letra maiúscula ------------"
);
